...
const $pr_page_radio = $pr_page.querySelectorAll('.radio-button');

/**
 * Объект для хранения данных блока формы
 * @type {{_selected: *[], _count: number, _total: number}}
 */
let pr_page_object = {_selected: [], _count: 0, _total: $pr_page.querySelectorAll('.processes-element').length};
let pr_page_blocks = {};
